...
#include "ProgressBar/Play_ProgressBar.h"
...
//是否有除字幕以外的子场景
static __bool __app_has_visuable_sub_scene_except_x(new_movie_ctrl_t *new_movie_ctrl, __u32 sub_scene);
...
void new_movie_ff_fb_over(new_movie_ctrl_t *new_movie_ctrl);
