...
static __s32  _ondraw(NEW_HTRUM htrum, H_WIN hwin)
{
	...
	if(htrum->is_internal_cmd)                                  // internal cmd to draw
	{
		...
		{
			__wrn("NOT support wake up in intertal cmd 1 ...\n");
			_save_locale(htrum);
		...
		{
			__wrn("NOT support wake up in intertal cmd 2 ...\n");
			_save_locale(htrum);
			htrum->is_internal_cmd = EPDK_FALSE;
			return 0;
		}
		...
		{
			__wrn("NOT support wake up in intertal cmd 3 ...\n");
			__wrn("htrum = %d...\n",htrum);
		...
		__wrn("NOT support wake up in intertal cmd 4 ...\n");
	...
	{
		__wrn("NOT support wake up in intertal cmd 5 ...\n");
