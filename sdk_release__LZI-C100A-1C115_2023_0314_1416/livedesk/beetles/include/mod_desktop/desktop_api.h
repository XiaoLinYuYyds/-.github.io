...
typedef struct DESKTOP_API_ENTRY
{
	...
	__s32(*ptr_dsk_display_lcd_off)(__u8);
	__s32(*ptr_dsk_display_set_lcd_pwm)(__lion_bright_t level);
	__lion_bright_t	(*ptr_dsk_display_get_lcd_pwm)(void);
	__s32(*ptr_dsk_set_display_global)(__u32, __disp_cmd_t);
	__s32(*ptr_dsk_get_display_global)(__disp_cmd_t);
	__s32(*ptr_dsk_display_set_lcd_pwm_ex)(__lion_bright_t level);
	__lion_bright_t	(*ptr_dsk_display_get_lcd_pwm_ex)(void);
	void	(*ptr_dsk_display_lcd_reserved[3])(void);
	//dsk_display_misc.h
	...
	void	(*ptr_dsk_keytone_wait_audio_finish)(void);
	void	(*ptr_dsk_keytone_reserved[2])(void);
	...
	//dsk_power.h
	__s32(*ptr_dsk_power_get_battery_level)(__u8 *level);                             // 剩余电量level
	...
	__bool(*ptr_dsk_power_is_full_charge)(void);
	...
	void	(*ptr_dsk_radio_rcv_autosearch_suspend)(void);
	void	(*ptr_dsk_radio_rcv_autosearch_resume)(void);
	__s32(*ptr_dsk_radio_rcv_search_stop)(void);
	...
	__s32(*ptr_dsk_radio_rcv_search_matching_frep)(__u32 freq);
	...
	///////////////////////echo begin
	__s32(*ptr_dsk_audio_echo_open)(__audio_rec_user_t type, __s32 auto_clean_buf);
...
#if SP_Software_Echo
	__s32(*ptr_dsk_echo_level_get_setting)(void);
	void	(*ptr_dsk_echo_level_set)(__s32 level);
	void (*ptr_dsk_echo_level_init)(void);
	__s8 (*ptr_dsk_echo_level_get)(void);
#endif
...
#define	dsk_display_set_lcd_pwm			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_set_lcd_pwm)
#define	dsk_display_get_lcd_pwm			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_get_lcd_pwm)
#define	dsk_set_display_global					(DESKTOP_FUNC_ENTRY->ptr_dsk_set_display_global)
#define	dsk_get_display_global					(DESKTOP_FUNC_ENTRY->ptr_dsk_get_display_global)
#define	dsk_display_set_lcd_pwm_ex			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_set_lcd_pwm_ex)
#define	dsk_display_get_lcd_pwm_ex			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_get_lcd_pwm_ex)
...
#define	dsk_keytone_wait_audio_finish  		(DESKTOP_FUNC_ENTRY->ptr_dsk_keytone_wait_audio_finish)
...
#define	dsk_power_is_full_charge			    (DESKTOP_FUNC_ENTRY->ptr_dsk_power_is_full_charge)
...
#define dsk_radio_rcv_autosearch_suspend	(DESKTOP_FUNC_ENTRY->ptr_dsk_radio_rcv_autosearch_suspend)
#define dsk_radio_rcv_autosearch_resume		(DESKTOP_FUNC_ENTRY->ptr_dsk_radio_rcv_autosearch_resume)
#define dsk_radio_rcv_search_stop		(DESKTOP_FUNC_ENTRY->ptr_dsk_radio_rcv_search_stop)
...
#define dsk_radio_rcv_search_matching_frep	(DESKTOP_FUNC_ENTRY->ptr_dsk_radio_rcv_search_matching_frep)
...
#if SP_Software_Echo
#define dsk_echo_level_get_setting			                (DESKTOP_FUNC_ENTRY->ptr_dsk_echo_level_get_setting                            )
#define dsk_echo_level_set			                (DESKTOP_FUNC_ENTRY->ptr_dsk_echo_level_set                            )
#define dsk_echo_level_init			                (DESKTOP_FUNC_ENTRY->ptr_dsk_echo_level_init                            )
#define dsk_echo_level_get			                (DESKTOP_FUNC_ENTRY->ptr_dsk_echo_level_get                            )
#endif
