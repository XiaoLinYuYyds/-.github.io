...
static void record_view_Bottom(precord_view_t prec_view)
{
	...
	GUI_RECT rect = {145 + 146 - 20 + 40, 453 + 120, 198 + 146 - 20 + 40, 473 + 120};	//停止、录音文字的位置
	GUI_COLOR txt_color;
	...
	//record 里面的format
	draw_record_mapping(prec_view->pui, MENU_FORMAT - prec_view->menuOsffset, menuList[MENU_FORMAT - prec_view->menuOsffset], prec_view->menuOsffset);
}
...
static void record_view_recInfo(precord_view_t prec_view)
{
	...
	GUI_RECT rectName = {130 + 160 + 80, 114 + 100, 370 + 160 + 80, 136 + 100}; //录音文件名字
	GUI_RECT rectSize = {380 + 160 + 80, 114 + 100, 470 + 160 + 80, 136 + 100}; //录音文件大小
	GUI_RECT rectQuty = {2 + 160 + 80, 112 + 100, 106 + 160 + 80, 133 + 100}; //录音质量
	...
	{
		GUI_DispStringAt("99:59:59", 130, 26);
	}
	else
	{
		record_s_to_char(curRecTimes, prec_view->precord_doc->diskFreeTime, ':');
		GUI_DispStringAt(curRecTimes, 130, 26);
	}
...
static void record_view_menuBox(precord_view_t prec_view)
{
	if(prec_view->curMenuSt == FOCUSE_PRESS)
	{
		switch(prec_view->curMenu)
		{
			...
			case MENU_FORMAT:
				draw_record_bmp_ext(prec_view->pui, RECORD_FORMAT_BK_BMP/*RECORD_QUALITY_BK_BMP*/, 356, 0);
				draw_record_bmp_ext(prec_view->pui, RECORD_QUALITY_FLAG_BMP, 766, prec_view->precord_doc->audioType * -27);

				if(prec_view->precord_doc->audioTypeTemp == 0)
				{
					GUI_SetColor(APP_COLOR_WHITE);
					//GUI_DispStringAt( "WMA", 328, 129-4 );
					GUI_DispStringAt("WAV", 408 + 260 + 230, 156 + 25 + 208 + 120);
					GUI_SetColor(APP_COLOR_YELLOW);
					GUI_DispStringAt("MP3", 408 + 260 + 230, 183 + 25 + 208 + 120);
				}
				...
				{
					GUI_SetColor(APP_COLOR_WHITE);
					GUI_DispStringAt("WAV", 328 + 260 + 230, 156 + 25 + 208 + 120);
					GUI_DispStringAt("MP3", 328 + 260 + 230, 183 + 25 + 208 + 120);
					GUI_SetColor(APP_COLOR_YELLOW);
