	...
	if(KEY_UP_ACTION != msg->dwAddData2)
	{
		switch(msg->dwAddData1)
		{
			case GUI_MSG_KEY_ENTER:
				...
				{
					play_or_pause = 1;
					plistviewFrm_ctl->plistView->curMenu = MUSIC_MENU_PLAY;//zzj
					plistviewFrm_ctl->plistView->playMenu = MUSIC_MENU_PLAY;
				...
				{
					play_or_pause = 0;
					plistviewFrm_ctl->plistView->curMenu = MUSIC_MENU_PAUSE;//zzj
					plistviewFrm_ctl->plistView->playMenu = MUSIC_MENU_PAUSE;
...
static __s32 _rec_list_view_frm_pre(__gui_msg_t *msg)
{
	...
	_rec_list_view_frm_play(msg);//上一曲直接播放
	play_or_pause = 0;
	plistviewFrm_ctl->plistView->curMenu = MUSIC_MENU_PAUSE;//zzj
	plistviewFrm_ctl->plistView->playMenu = MUSIC_MENU_PAUSE;
	return EPDK_OK;
...
static __s32 _rec_list_view_frm_next(__gui_msg_t *msg)
{
	...
	_rec_list_view_frm_play(msg); //下一曲直接播放
	play_or_pause = 0;
	plistviewFrm_ctl->plistView->curMenu = MUSIC_MENU_PAUSE;//zzj
	plistviewFrm_ctl->plistView->playMenu = MUSIC_MENU_PAUSE;
	return EPDK_OK;
