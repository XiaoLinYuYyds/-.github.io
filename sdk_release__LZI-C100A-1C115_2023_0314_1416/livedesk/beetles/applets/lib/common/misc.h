...
#define VK_UP                            GUI_MSG_KEY_UP
#define VK_DOWN                            GUI_MSG_KEY_DOWN
#define VK_LEFT                             GUI_MSG_KEY_LEFT
#define VK_RIGHT                            GUI_MSG_KEY_RIGHT
#define VK_PSUB					GUI_MSG_KEY_PSUB
#define VK_PADD					GUI_MSG_KEY_PADD
...
#ifndef SEND_MSG
#define SEND_MSG(mid, src, des, d1, d2, reserved) \
	do{\
		__gui_msg_t  exmsg={0}; \
		exmsg.id = mid; \
		exmsg.h_srcwin = src; \
