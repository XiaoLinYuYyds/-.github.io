...
#define SP_APP_SETTING_POWER						0

#define SET_ITEM_START_X 270	//通用设置区域
#define SET_ITEM_START_Y  20
#define SET_ITEM_H  30
#define SET_ITEM_W 240

#define SET_CONT_START_X 410	//通用设置里面的内容，两个黄色三角形内的文字
#define SET_CONT_START_Y  20
#define SET_CONT_H  30
