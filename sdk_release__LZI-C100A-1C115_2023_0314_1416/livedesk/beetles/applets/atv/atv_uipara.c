...
#define ITEM_PER_COL 		1
#define ITEM_PER_LINE 	(MAX_ITEM_NUM /ITEM_PER_COL)

#define HORI_SPACE ((SCN_W-ITEM_W*ITEM_PER_LINE)/(ITEM_PER_LINE+1))
#define VERT_SPACE ((SCN_H-HBAR_H-ITEM_H*ITEM_PER_COL)/(ITEM_PER_COL+1))
...
static atv_uipara_t uipara_320_240 =
{
	{
		0, 0, 320, 240,
	},
...
static atv_uipara_t uipara_400_240 =
{
	{
		0, 171, 400, 240 - 171
	},
...
static atv_uipara_t uipara_480_272 =
{
	{
	...
	{
		{
			POS_X(0, 0), 50, ITEM_W, ITEM_H
		},
		{
			POS_X(1, 0), 50, ITEM_W, ITEM_H
		},
		{
			POS_X(2, 0), 50, ITEM_W, ITEM_H
		},
		{
			POS_X(3, 0), 50, ITEM_W, ITEM_H
		},
	},
...
static atv_uipara_t uipara_800_480 =
{
	{
		0, 0, 800, 480//0, 185, 480, 272-185
	},
	{
		0, 0, 800, 480//0, 185, 480, 272-185
	},
	...
	{
		{
			POS_X(0, 0), 20, ITEM_W, ITEM_H
		},
		{
			POS_X(1, 0), 20, ITEM_W, ITEM_H
		},
		{
			POS_X(2, 0), 20, ITEM_W, ITEM_H
		},
		{
			POS_X(3, 0), 20, ITEM_W, ITEM_H
		},
	},
