...
static __s32  _ondraw(HTRUM htrum, H_WIN hwin)
{
	if(htrum->is_internal_cmd)                                  // internal cmd to draw
	{
		...
		{
			__wrn("NOT support wake up in intertal 1 cmd.\n");
			_save_locale(htrum);
		...
		{
			__wrn("NOT support wake up in intertal 2 cmd.\n");
			_save_locale(htrum);
			htrum->is_internal_cmd = EPDK_FALSE;
			return 0;
		}
		...
		{
			__wrn("NOT support wake up in intertal 3 cmd.\n");
			_save_locale(htrum);
			htrum->is_internal_cmd = EPDK_FALSE;
			return 0;
		}
		...
		{
			__wrn("NOT support wake up in intertal 4 cmd.\n");
		...
		__wrn("NOT support wake up in intertal 5 cmd.\n");
	...
	{
		__wrn("NOT support wake up in intertal 6 cmd.\n");
