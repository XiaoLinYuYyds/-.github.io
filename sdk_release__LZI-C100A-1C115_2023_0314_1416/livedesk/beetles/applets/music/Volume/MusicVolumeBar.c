...
__s32 MusicVolumeBarCreate(music_player_ctrl_t *This)
{
	...
	VBPara.Event.VolAddKey = GUI_MSG_KEY_VADD;
	VBPara.Event.VolAddRepeatKey = GUI_MSG_KEY_LONGVADD;
	VBPara.Event.VolDecKey = GUI_MSG_KEY_VDEC;
	VBPara.Event.VolDecRepeatKey = GUI_MSG_KEY_LONGVDEC;
