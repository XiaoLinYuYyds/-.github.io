...
#if SP_FavoriteFiles
extern __s32 music_play_status;
#endif
...
extern __s32 app_music_get_index(H_WIN music_man_win, __u32 *index);
extern __s32 app_music_get_root_type(H_WIN music_man_win, __u32 *root_type);
extern __s32 app_music_get_mode(H_WIN music_man_win);
extern __s32 app_music_set_bg_mode(H_WIN music_man_win);
