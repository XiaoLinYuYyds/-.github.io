#ifndef		__NEW_MOVIE_SPSC_CTRL_MENU_I_H
#define		__NEW_MOVIE_SPSC_CTRL_MENU_I_H
...
typedef enum
{
  spsc_ctrl_menu_scene_id = 1231,
  spsc_menu_prog_scene_id,
  spsc_menu_scene_id_max
} spsc__menu_scene_id_t;
