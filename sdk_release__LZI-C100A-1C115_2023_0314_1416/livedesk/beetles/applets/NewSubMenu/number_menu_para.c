...
{
	{0, 0},				//提示框背景图坐标位置
	{0, 0, 80, 20},		//number:00提示框控件坐标位置大小
	{0, 0},			//回车按键点击数坐标位置
	{0, 0},			//暂时不用的坐标位置
	{0, 0},//OK 字符显示底图坐标{(191 -37) >>1, 75}
	...
	#if 1
		{APP_POS_X(1, 0), APP_POS_Y(0, 0) ,APP_W ,APP_H},//2
		{APP_POS_X(2, 0), APP_POS_Y(0, 0) ,APP_W ,APP_H},//3
		{APP_POS_X(3, 0), APP_POS_Y(0, 0) ,APP_W ,APP_H},//4
		{APP_POS_X(0, 0), APP_POS_Y(0, 1) ,APP_W ,APP_H},//5
		{APP_POS_X(1, 0), APP_POS_Y(0, 1) ,APP_W ,APP_H},//6
		{APP_POS_X(2, 0), APP_POS_Y(0, 1) ,APP_W ,APP_H},//7
		{APP_POS_X(3, 0), APP_POS_Y(0, 1) ,APP_W ,APP_H},//8
	#endif
	}, //app应用图片8个的显示坐标
	//下面的参数用到再设置
	#if 0
