...
extern __s32 LogoOpen(const char *a_pcLogoPath);
extern __s32 LogoClose(void);
extern __s32 LogoBufRelease(void);

#define PATH__LOGO_DEFAULT			BEETLES_APP_ROOT"res\\boot_ui\\logo.bmp"
