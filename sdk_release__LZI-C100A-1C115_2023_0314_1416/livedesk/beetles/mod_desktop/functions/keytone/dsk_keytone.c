...
void dsk_keytone_wait_audio_finish(void)
{
	do
	{
		//µÈ´ý·¢Òô½áÊø
		...
		while(cnt < 50)
		{
			data_size = eLIBs_fioctrl(keytone->f_audiodev, AUDIO_DEV_CMD_QUERY_BUFSIZE, AUDIO_DEV_QUERY_BUF_SIZE_DATA, 0);
