...
* date:             2009-12-01
*
* Description:      dsk_radio ´ò¿ªº¯Êý(³õÊ¼»¯FM²¥·Å¹¦ÄÜ)
*
* parameters:
*
...
__pCBK_t dsk_radio_set_cb(dsk_radio_event_e event, __pCBK_t cb, void *ctx)
{
	...
	switch(event)
	{
		...
		case DSK_RADIO_EVENT_SEARCH_FREQ:           //ÏÔÊ¾ÄÚ²¿ËÑË÷¹ý³ÌÖÐµÄÆµÂÊ
		{
...
* date:             2009-12-01
*
* Description:      dsk_radio¹¦ÄÜ²Ù×÷½Ó¿Ú,²ÎÊý1Ò»°ãÎªÊäÈë²ÎÊý£¬²ÎÊý2ÎªÊä³ö²ÎÊý
*
* parameters:
*
