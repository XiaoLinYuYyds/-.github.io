...
#define USE_IO_32KHZ_CLK							1
#define SHARE_CRYSTAL_32KHz					2
#define USE_IO_12MHZ_CLK							3
#define SHARE_CRYSTAL_12MHz					4
#define USE_IO_12MHZ_CLK_RC					5
#define SHARE_CRYSTAL_24MHz					6

#define FM_CLOCK								SHARE_CRYSTAL_24MHz
...
*******************************************************************************/
#if ((FM_CLOCK == USE_IO_32KHZ_CLK) || (FM_CLOCK == SHARE_CRYSTAL_32KHz))
//crystal clock is 32768HZ
#define QN8065_XTAL_DIV0_VAL                   	0x01
#define QN8065_XTAL_DIV1_VAL                   	0x80
#define QN8065_XTAL_DIV2_VAL                   	0x6e

#elif ((FM_CLOCK == USE_IO_12MHZ_CLK) || (FM_CLOCK == SHARE_CRYSTAL_12MHz) || (FM_CLOCK == USE_IO_12MHZ_CLK_RC))
...
extern __s32 QN8065_WriteReg(u8 adr, u8 value);
