...
#include "app_new_menu.h"
#include "new_main_menu.h"
#include "new_menu_uipara.h"
#include "msgbox.h"
#include "app_new_menu_i.h"
...
{	
	...
	home_para->h_submenu = number_menu_numbers_win_create(home_para->h_app_main, (number_menu_number_para_t*)&smenu_para);//sub_menu_win_create(home_para->h_app_main, &smenu_para);
