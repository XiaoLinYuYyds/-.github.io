...
{	
	...
	rect.x = home_ui_para->lyr_main_menu.x;		//设置主窗口x轴坐标 0
	rect.y = home_ui_para->lyr_main_menu.y;		//设置主窗口y轴坐标 0
...
{	
	...
	smenu_para.layer = home_para->lyr_smenu;				//一图层赋值，没有选中app应用前的图层
	...
	smenu_para.bg_layer = home_para->lyr_smenu;				//二图层，选中app应用的的背影图层
