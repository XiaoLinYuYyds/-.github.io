...
#define KMSG_USR_SYSTEM_MIC_PLUGIN						(KMSG_USR_CLS_SYSTEM | 0x150)
#define KMSG_USR_SYSTEM_MIC_PLUGOUT					(KMSG_USR_CLS_SYSTEM | 0x151)
#define KMSG_USR_SYSTEM_AUX_PLUGIN					(KMSG_USR_CLS_SYSTEM | 0x152)
#define KMSG_USR_SYSTEM_AUX_PLUGOUT					(KMSG_USR_CLS_SYSTEM | 0x153)
