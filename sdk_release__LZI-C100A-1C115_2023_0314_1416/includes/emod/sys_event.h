...
// 遥控键:
	...
	m_eKeyShiftMapping_up,							// 上
	m_eKeyShiftMapping_down,						// 下
	m_eKeyShiftMapping_left,						// 左
	m_eKeyShiftMapping_right,						// 右
	m_eKeyShiftMapping_enter,						// 确认
	
	m_eKeyShiftMapping_power,						// 电源
	m_eKeyShiftMapping_display,					// 屏显
	m_eKeyShiftMapping_lockScreen,			// 屏开/关
	m_eKeyShiftMapping_zoom,						// 缩放
	
	m_eKeyShiftMapping_stop,						// 停止
	m_eKeyShiftMapping_playPause,				// 播放/暂停
	m_eKeyShiftMapping_repeat,					// 重复
	m_eKeyShiftMapping_ab,							// A-B
	m_eKeyShiftMapping_slowForward, 		// 慢放
	m_eKeyShiftMapping_fastForward, 		// 快进
	m_eKeyShiftMapping_fastBackward,		// 快退
	m_eKeyShiftMapping_prev,            // 上曲
	m_eKeyShiftMapping_next,            // 下曲

	m_eKeyShiftMapping_setting,					// 设置
	m_eKeyShiftMapping_menu,						// 菜单
	m_eKeyShiftMapping_mute,						// 静音
	m_eKeyShiftMapping_soundChannel,		// 声道
	m_eKeyShiftMapping_voiceDown,				// 音量-
	m_eKeyShiftMapping_voiceUp, 				// 音量+
	
	m_eKeyShiftMapping_channelSearch,		// 搜台
	m_eKeyShiftMapping_selTime,					// 选时
	m_eKeyShiftMapping_subTitle,				// 字幕
	m_eKeyShiftMapping_angle,						// 角度
	m_eKeyShiftMapping_caption,					// 标题
	m_eKeyShiftMapping_program, 				// 编程
	m_eKeyShiftMapping_sys, 						// 制式
...
// 面板键:
	...
	m_eKeyShiftMapping_panel_up,				// 上
	m_eKeyShiftMapping_panel_down,			// 下
	m_eKeyShiftMapping_panel_left,			// 左
	m_eKeyShiftMapping_panel_right,			// 右
	m_eKeyShiftMapping_panel_enter,			// 确认
	m_eKeyShiftMapping_panel_menu,			// 菜单
	m_eKeyShiftMapping_panel_takeout,		// 开出仓键
