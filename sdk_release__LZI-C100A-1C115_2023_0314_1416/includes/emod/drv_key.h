...
typedef enum __DRV_KEY_CMD
{
	...
	DRV_KEY_CMD_SET_POWER_FLAGS,
	DRV_KEY_CMD_GET_ECHO_LEVEL,
	DRV_KEY_CMD_GET_DEBUG_INFO,
	DRV_KEY_CMD_DET_MIC_PLUG_EN,
	DRV_KEY_CMD_DET_MIC_PLUG_DIS,
	DRV_KEY_CMD_DET_AUX_PLUG_EN,
	DRV_KEY_CMD_DET_AUX_PLUG_DIS,
	...
	DRV_IRKEY_CMD_GET_IR_KEY_VALUE,
} __drv_key_cmd_t;
#define OP_GetDebugInfo_X1		1
#define OP_GetDebugInfo_X2		2


typedef struct
{
	__s16 min, max;
}S_KEYPAD_AD, *PS_KEYPAD_AD;

typedef struct
{
	PS_KEYPAD_AD 	psKeypadAD;
	__u16					psKeypadAD_size;
	__s32	m_cur, m_min, m_max;
} S_ADSampling, *PS_ADSampling;
