...
// for __drv_power_fuelguage_t.is_low_power :
#define LEVEL_LowBattery_Normal 			1	// 正常低电门槛
#define LEVEL_LowBattery_Limit				2	// 低电极限门槛
typedef enum
{
  m_eDrvPowerFuelguageIdx_fast = 0,
  m_eDrvPowerFuelguageIdx_slow,
  m_eDrvPowerFuelguageIdx_total
} E_DRV_POWRE_FUELGUAGE_IDX;
...
typedef enum __DRV_POWER_CMD_GROUP
{
  ...
  DRV_POWER_CMD_GET_FUELGUAGE_FAST,
